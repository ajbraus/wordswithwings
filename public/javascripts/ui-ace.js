  ...
  .directive('uiAce', ['uiAceConfig', function (uiAceConfig) {
    ...
    return {
      ...
      link: function (scope, elm, attrs, ngModel) {
         ...
         */
        var onBlurListener, onPasteListener;
        ...
        var updateOptions = function (current, previous) {
          ...
          // bind new paste listener
          onPasteListener = listenerFactory.onPaste(opts.onPaste);
          acee.on('paste', onPasteListener);

          // acee.on('paste', function(e){
          //   console.log("#############");
          // });
